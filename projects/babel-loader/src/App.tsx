// we need this for regenerator runtime if using async functions and targeting 'defaults'
// in preset-env. If you change to 'chrome 80' for example, you can remove these
// first two lines
